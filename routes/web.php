...
Route::group(['middleware' => ['guest']], function () {
  Route::get('/', [ProfilGerejaController::class, 'index'])->name('profilGereja');
...
Route::group(['middleware' => ['auth']], function () {
  Route::group(['middleware' => 'role:Admin'], function () {
    ...
    Route::get('/kelola-data-menikah/{id}', [KelolaDataMenikahController::class, 'show'])->name(
      'kelola-data-menikah.show'
    );
    Route::put('/kelola-data-menikah/{id}', [KelolaDataMenikahController::class, 'update'])->name(
      'kelola-data-menikah.update'
    );

    Route::get('/kelola-data-baptis', [KelolaDataBaptisController::class, 'index'])->name('kelola-data-baptis');
    Route::get('/kelola-data-baptis/{id}', [KelolaDataBaptisController::class, 'show'])->name(
      'kelola-data-baptis.show'
    );
    Route::put('/kelola-data-baptis/{id}', [KelolaDataBaptisController::class, 'update'])->name(
      'kelola-data-baptis.update'
    );
  ...
  Route::group(['middleware' => 'role:Jemaat'], function () {
    ...
    Route::post('/unduh-sertifikat-baptis', [ProfileController::class, 'unduhSertifikatBaptis'])->name(
      'unduh-sertifikat-baptis'
    );

    Route::get('/pendaftaran-menikah', [PendaftaranMenikahController::class, 'create'])->name('pendaftaran-menikah');
    Route::post('/pendaftaran-menikah', [PendaftaranMenikahController::class, 'store'])->name(
      'pendaftaran-menikah.store'
    );
    Route::post('/cek-status-menikah', [PendaftaranMenikahController::class, 'cekStatusMenikah'])->name(
      'cek-status-menikah'
    );
    ...
    Route::post('/cek-status-baptis', [PendaftaranBaptisController::class, 'cekStatusBaptis'])->name(
      'cek-status-baptis'
    );
