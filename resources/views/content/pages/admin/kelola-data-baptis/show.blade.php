...
@section('content')
    ...
    <div class="row">
        <div class="card-header">
            <h5 class="mb-2 fw-bold bg-primary text-white p-2 rounded shadow-lg">Identitas Jemaat Baptis</h5>
        </div>
        <div class="card mb-4">
            <div class="card-body">
                <div>
                        ...
                        <form action="/kelola-data-baptis/{{ $data->id }}" method="POST">
                            ...
                            <div class="d-flex py-1 justify-content-center">
                                <div class="me-2 d-flex flex-column justify-content-center">
                                    <button type="submit" class="btn btn-primary" name="action" value="konfirmasi_baptis">
                                ...
                                <div class="d-flex flex-column justify-content-center">
                                    <button type="submit" class="btn btn-danger" name="action" value="tolak_baptis">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
