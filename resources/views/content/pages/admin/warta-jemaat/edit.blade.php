    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="/warta-jemaat/{{ $data->id }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="d-flex">
                            <div class="form-floating form-floating-outline mb-4 flex-fill mx-2">
                                <input type="date" name="tanggal" class="form-control" id="tanggal"
                                    placeholder="Masukkan Tanggal Lahir" value="{{ $data->tanggal }}" />
                        ...
                        <div class="d-flex">
                            <div class="form-floating form-floating-outline mb-4 flex-fill mx-2">
                                <input type="text" name="nama_khutbah" class="form-control" id="nama_khutbah"
                                    placeholder="Masukkan Nama Khutbah" value="{{ $data->nama_khutbah }}" />
                            ...
                            <div class="form-floating form-floating-outline mb-4 flex-fill mx-2">
                                <input type="text" name="ayat" class="form-control" id="ayat"
                                    placeholder="Masukkan Ayat" value="{{ $data->ayat }}" />
                        ...
                        <div class="mx-2">
                            ...
                            <div class="form-floating form-floating-outline mb-4 flex-fill mt-2">
                                <input id="isi" type="hidden" name="isi" value="{{ $data->isi }}" />
