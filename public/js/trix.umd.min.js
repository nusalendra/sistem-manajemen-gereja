...
!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(e)
    : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).Trix = e());
})(this, function () {
  'use strict';
  var t = '2.0.0';
  ...
  var o = {
      ...
      supportsInputEvents: (function () {
        ...
        for (const t of ['data', 'getTargetRanges', 'inputType']) if (!(t in InputEvent.prototype)) return !1;
        return !0;
      })()
    },
    s = {
  ...
  const c = '\ufeff',
    ...
    b = function (t) {
      let { matchingSelector: e, untilNode: i } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
    ...
    S = function (t) {
      ...
      'object' == typeof t ? ((n = t), (t = n.tagName)) : (n = { attributes: n });
      const r = document.createElement(t);
      if (
        (null != n.editable &&
          (null == n.attributes && (n.attributes = {}), (n.attributes.contenteditable = n.editable)),
        n.attributes)
      )
  ...
  const k = function () {
    ...
    w = function (t) {
      let { strict: e } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { strict: !0 };
      return e ? T(t) : T(t) || (!T(t.firstChild) && D(t));
    },
    T = t => F(t) && 'block' === (null == t ? void 0 : t.data),
    F = t => (null == t ? void 0 : t.nodeType) === Node.COMMENT_NODE,
    B = function (t) {
      let { name: e } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      if (t)
        return N(t) ? (t.data === c ? !e || t.parentNode.dataset.trixCursorTarget === e : void 0) : B(t.firstChild);
    },
    P = t => f(t, e),
    ...
    O = {
      ...
      pickFiles(t) {
        const e = S('input', { type: 'file', multiple: !0, hidden: !0, id: this.fileInputId });
  ...
  var M = { removeBlankTableCells: !1, tableCellSeparator: ' | ', tableRowSeparator: '\n' },
    j = {
      bold: {
        tagName: 'strong',
        inheritable: !0,
      ...
      italic: { tagName: 'em', inheritable: !0, parser: t => 'italic' === window.getComputedStyle(t).fontStyle },
      href: {
        groupTagName: 'a',
        parser(t) {
  ...
  class V {
    static proxyMethod(t) {
      ...
      this.prototype[e] = function () {
        ...
        return r
          ? ((t = null === (a = o) || void 0 === a ? void 0 : a[e]), t ? _.call(t, o, arguments) : void 0)
          ...
          return (() => {
            ...
            return (
              Array.from(t).forEach(t => {
                let i = '';
                t > 65535 &&
                  ((t -= 65536), (i += String.fromCharCode(((t >>> 10) & 1023) | 55296)), (t = 56320 | (1023 & t))),
  ...
  class Ft extends V {
    ...
    start() {
      if (!this.started)
        return (
          (this.started = !0),
          'onselectionchange' in document ? document.addEventListener('selectionchange', this.update, !0) : this.run()
        );
    }
    stop() {
    ...
    unregisterSelectionManager(t) {
      if (((this.selectionManagers = this.selectionManagers.filter(e => e !== t)), 0 === this.selectionManagers.length))
        return this.stop();
    }
  ...
  const Bt = (t, e) =>
      (null == t ? void 0 : t.startContainer) === (null == e ? void 0 : e.startContainer) &&
      (null == t ? void 0 : t.startOffset) === (null == e ? void 0 : e.startOffset) &&
      (null == t ? void 0 : t.endContainer) === (null == e ? void 0 : e.endContainer) &&
  ...
  class Xt {
    ...
    constructor() {
      ...
      (this.objects = t),
        i &&
          ((this.depth = e),
          (this.objects = this.constructor.groupObjects(this.objects, { asTree: i, depth: this.depth + 1 })));
    }
    getObjects() {
      return this.objects;
    }
  ...
  class te extends V {
    ...
    release() {
      var t, e;
      null === (t = this.promise) || void 0 === t || null === (e = t.cancel) || void 0 === e || e.call(t),
        (this.promise = null),
  ...
  class re extends ee {
    ...
    createNodes() {
      let t;
      const e = (t = S({ tagName: 'figure', className: this.getClassName(), data: this.getData(), editable: !1 })),
        i = this.getHref();
      return (
        i && ((t = S({ tagName: 'a', editable: !1, attributes: { href: i, tabindex: -1 } })), e.appendChild(t)),
        ...
        this.attachment.isPending() &&
          ((this.progressElement = S({
            tagName: 'progress',
            attributes: { class: ne.attachmentProgress, value: this.attachment.getUploadProgress(), max: 100 },
    ...
    createCaptionElement() {
      ...
      if (e) t.classList.add(''.concat(ne.attachmentCaption, '--edited')), (t.textContent = e);
        ...
        if (
          (n.name && (e = this.attachment.getFilename()), n.size && (i = this.attachment.getFormattedFilesize()), e)
        ) {
          const i = S({ tagName: 'span', className: ne.attachmentName, textContent: e });
          t.appendChild(i);
        }
        if (i) {
          e && t.appendChild(document.createTextNode(' '));
          const n = S({ tagName: 'span', className: ne.attachmentSize, textContent: i });
          t.appendChild(n);
        }
      }
      return t;
    ...
    getData() {
      ...
      return (
        e.isEmpty() || (t.trixAttributes = JSON.stringify(e)), this.attachment.isPending() && (t.trixSerialize = !1), t
      );
    }
    getHref() {
  ...
  const oe = t => S({ tagName: 'span', textContent: c, data: { trixCursorTarget: t, trixSerialize: !1 } }),
    se = function (t, e) {
      const i = S('div');
  ...
  class ae extends re {
    ...
    createContentNodes() {
      return (
        (this.image = S({ tagName: 'img', attributes: { src: '' }, data: { trixMutable: !0 } })),
    ...
    preserveSpaces(t) {
      return (
        ...
        (t = t
          ...
          .replace(/\ {2}/g, ' '.concat(u))),
        (this.context.isFirst || this.context.followsWhitespace) && (t = t.replace(/^\ /, u)),
        t
      );
    }
  }
  class ce extends ee {
    ...
    createNodes() {
      ...
      for (let r = 0; r < e.length; r++) {
        ...
        const a = this.findOrCreateCachedChildView(le, o, { textConfig: this.textConfig, context: s });
  ...
  class de extends ee {
    ...
    createContainerElement(t) {
      ...
      const n = this.attributes[t],
        { tagName: r } = dt(n);
      if ((0 === t && this.block.isRTL() && (e = { dir: 'rtl' }), 'attachmentGallery' === n)) {
  ...
  class Ce extends it {
    ...
    static attributesForFile(t) {
      return new _t({ filename: t.name, filesize: t.size, contentType: t.type });
    }
    static fromJSON(t) {
      return new this(t);
    }
      ...
      if (!this.attributes.isEqualTo(e))
        return (
          ...
          null === (i = this.previewDelegate) ||
            ...
            void 0 === n ||
            n.call(i, this),
          null === (r = this.delegate) || void 0 === r || null === (o = r.attachmentDidChangeAttributes) || void 0 === o
            ? void 0
            : o.call(r, this)
        );
    }
      ...
      if (t !== this.getPreviewURL())
        return (
          ...
          null === (e = this.previewDelegate) ||
            ...
            void 0 === i ||
            i.call(e, this),
          null === (n = this.delegate) || void 0 === n || null === (r = n.attachmentDidChangePreviewURL) || void 0 === r
            ? void 0
            : r.call(n, this)
        );
    }
      ...
      if (t && t !== this.getPreviewURL()) {
        ...
        return new ye(t)
          .then(i => {
            ...
            return (
              (this.getWidth() && this.getHeight()) || this.setAttributes({ width: n, height: r }),
  ...
  class Re extends xe {
    ...
    isEqualTo(t) {
      ...
      return (
        super.isEqualTo(t) &&
        this.attachment.id === (null == t || null === (e = t.attachment) || void 0 === e ? void 0 : e.id)
      );
    }
    toString() {
      return '￼';
    ...
    consolidate() {
      ...
      return (
        this.objects.slice(1).forEach(i => {
          var n, r;
          null !== (n = (r = e).canBeConsolidatedWith) && void 0 !== n && n.call(r, i)
  ...
  class we extends it {
    ...
    isEqualTo(t) {
      ...
      return (
        super.isEqualTo(t) ||
        (null == t || null === (e = t.pieceList) || void 0 === e ? void 0 : e.isEqualTo(this.pieceList))
      );
    }
    isBlockBreak() {
  ...
  class Te extends it {
    ...
    isEqualTo(t) {
      return (
        !!super.isEqualTo(t) ||
        (this.text.isEqualTo(null == t ? void 0 : t.text) && nt(this.attributes, null == t ? void 0 : t.attributes))
      );
    }
    copyWithText(t) {
      ...
      return (
        0 === t
          ...
          : ((e = this.copyWithText(this.text.getTextAtRange([0, t]))),
            (i = this.copyWithText(this.text.getTextAtRange([t, this.getLength()])))),
        [e, i]
      );
    }
  ...
  class qe extends it {
    ...
    copy() {
      const t = (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}).consolidateBlocks
    ...
    insertTextAtRange(t, e) {
      ...
      return new this.constructor(
        o.blockList.editObjectAtIndex(n, e => e.copyWithText(e.text.insertTextAtPosition(t, r)))
      );
    }
    removeTextAtRange(t) {
      let e;
      ...
      if (
        ...
        e = this.blockList.editObjectAtIndex(c, t => t.copyWithText(t.text.removeTextAtRange([u, u + 1])));
      else {
        let t;
        const i = l.text.getTextAtRange([0, a]),
          ...
          r = i.appendText(n);
        t =
          s !== c && 0 === a && l.getAttributeLevel() >= h.getAttributeLevel() ? h.copyWithText(r) : l.copyWithText(r);
        const o = c + 1 - s;
    ...
    moveTextFromRangeToPosition(t, e) {
      ...
      return (
        0 === c.length ? ((i = l.getTextWithoutBlockBreak()), a && (e += 1)) : (i = l.text),
        (s = s.insertTextAtRange(i, e)),
        0 === c.length ? s : ((o = new this.constructor(c)), (e += i.getLength()), s.insertDocumentAtRange(o, e))
      );
    }
    addAttributeAtRange(t, e, i) {
    ...
    addAttribute(t, e) {
      ...
      return (
        this.eachBlock((n, r) => (i = i.editObjectAtIndex(r, () => n.addAttribute(t, e)))), new this.constructor(i)
      );
    }
    removeAttributeAtRange(t, e) {
      let { blockList: i } = this;
      return (
        this.eachBlockAtRange(e, function (e, n, r) {
          dt(t)
            ...
            : n[0] !== n[1] && (i = i.editObjectAtIndex(r, () => e.copyWithText(e.text.removeAttributeAtRange(t, n))));
        }),
    ...
    updateAttributesForAttachment(t, e) {
      ...
      return new this.constructor(
        this.blockList.editObjectAtIndex(r, i => i.copyWithText(o.updateAttributesForAttachment(t, e)))
      );
    }
    ...
    insertBlockBreakAtRange(t) {
      ...
      return (
        0 === n && (e = [new Te()]), new this.constructor(r.blockList.insertSplittableListAtPosition(new Ee(e), i))
      );
    }
    ...
    expandRangeToLineBreaksAndSplitBlocks(t) {
      ...
      if (
        ((r.offset = a.findLineBreakInDirectionFromPosition('backward', r.offset)),
        null != r.offset &&
        ...
        (o.index -= 1), (o.offset = s.getBlockAtIndex(o.index).getBlockBreakPosition());
      else {
        const t = s.getBlockAtIndex(o.index);
        '\n' === t.text.getStringAtRange([o.offset - 1, o.offset])
          ? (o.offset -= 1)
          : (o.offset = t.findLineBreakInDirectionFromPosition('forward', o.offset)),
          o.offset !== t.getBlockBreakPosition() &&
            ((e = s.positionFromLocation(o)), (s = s.insertBlockBreakAtRange([e, e + 1])));
      }
      return (i = s.positionFromLocation(r)), (n = s.positionFromLocation(o)), { document: s, range: (t = kt([i, n])) };
    }
    ...
    findRangesForTextAttribute(t) {
      let { withValue: e } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
        i = 0,
        n = [];
      const r = [];
      return (
    ...
    toSerializableDocument() {
      const t = [];
      return (
        this.blockList.eachObject(e => t.push(e.copyWithText(e.text.toSerializableText()))), new this.constructor(t)
      );
    }
    toString() {
  ...
  class $e extends V {
    ...
    constructor(t) {
      let { referenceElement: e } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      super(...arguments),
        (this.html = t),
    ...
    appendBlockForTextNode(t) {
      ...
      if (e === this.containerElement || this.isBlockElement(e)) {
        ...
        nt(t, null === (i = this.currentBlock) || void 0 === i ? void 0 : i.attributes) ||
          ((this.currentBlock = this.appendBlockForAttributesWithElement(t, e)), (this.currentBlockElement = e));
      }
    }
    ...
    processTextNode(t) {
      ...
      var i;
      Xe(t.parentNode) ||
        ((e = Ut(e)), ii(null === (i = t.previousSibling) || void 0 === i ? void 0 : i.textContent) && (e = ti(e)));
    ...
    getTextAttributes(t) {
      ...
      for (const n in j) {
        const r = j[n];
        if (r.tagName && b(t, { matchingSelector: r.tagName, untilNode: this.containerElement })) i[n] = !0;
        else if (r.parser) {
          if (((e = r.parser(t)), e)) {
            let o = !1;
    ...
    getBlockAttributes(t) {
      ...
      for (; t && t !== this.containerElement; ) {
        for (const r in n) {
          ...
          if (!1 !== o.parse)
            if (R(t) === o.tagName)
              ((null !== (i = o.test) && void 0 !== i && i.call(o, t)) || !o.test) &&
    ...
    isInsignificantTextNode(t) {
      ...
      return (Ye(e.previousSibling) && !this.isBlockElement(e.previousSibling)) || Xe(e)
        ? void 0
  ...
  const Xe = function (t) {
    ...
    Qe = function (t) {
      const e = window.getComputedStyle(t);
      if ('block' === e.display) return { top: parseInt(e.marginTop), bottom: parseInt(e.marginBottom) };
    },
    Ze = function (t) {
    ...
    ai = {
      ...
      'text/html': function (t) {
        ...
        return (
          Array.from(e.querySelectorAll('[data-trix-serialize=false]')).forEach(t => {
            y(t);
          }),
          ni.forEach(t => {
  ...
  class ui extends V {
    ...
    manageAttachment(t) {
      return (
        this.managedAttachments[t.id] || (this.managedAttachments[t.id] = new ci(this, t)),
  ...
  class di extends V {
    ...
    setDocument(t) {
      ...
      if (!t.isEqualTo(this.document))
        return (
          ...
          this.revision++,
          null === (e = this.delegate) || void 0 === e || null === (i = e.compositionDidChangeDocument) || void 0 === i
            ? void 0
            : i.call(e, t)
        );
    }
    ...
    loadSnapshot(t) {
      ...
      return (
        ...
        null === (n = this.delegate) || void 0 === n || null === (r = n.compositionDidLoadSnapshot) || void 0 === r
          ? void 0
          : r.call(n)
      );
    }
    insertText(t) {
      let { updatePosition: e } =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { updatePosition: !0 };
    ...
    deleteInDirection(t) {
      let e,
        i,
        n,
        { length: r } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      const o = this.getLocationRange();
      let s = this.getSelectedRange();
      const a = Lt(s);
      if (
        (a ? (i = 'backward' === t && 0 === o[0].offset) : (n = o[0].index !== o[1].index),
        i && this.canDecreaseBlockAttributeLevel())
      ) {
        const t = this.getBlock();
        if (
          (t.isListItem() ? this.decreaseListLevel() : this.decreaseBlockAttributeLevel(),
      ...
      return (
        ...
        e
          ...
          : (this.setDocument(this.document.removeTextAtRange(s)), this.setSelection(s[0]), !i && !n && void 0)
      );
    }
    moveTextFromRange(t) {
    ...
    removeAttachment(t) {
      ...
      if (e)
        return (
          this.stopEditingAttachment(), this.setDocument(this.document.removeTextAtRange(e)), this.setSelection(e[0])
        );
    }
    ...
    selectPlaceholder() {
      if (null != this.placeholderPosition)
        return (
          this.setSelectedRange([this.placeholderPosition, this.placeholderPosition + ' '.length]),
    ...
    setBlockAttribute(t, e) {
      ...
      if (this.canSetCurrentAttribute(t))
        return this.setDocument(this.document.applyBlockAttributeAtRange(t, e, i)), this.setSelection(i);
    }
    ...
    canIncreaseNestingLevel() {
      ...
      const e = this.getBlock();
      if (e) {
        if (null === (t = dt(e.getLastNestableAttribute())) || void 0 === t || !t.listAttribute)
    ...
    getLocationRange(t) {
      return this.targetLocationRange
        ...
        : this.getSelectionManager().getLocationRange(t) || kt({ index: 0, offset: 0 });
    }
    ...
    getExpandedRangeInDirection(t) {
      let { length: e } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
    ...
    attachmentDidChangeAttributes(t) {
      ...
      return (
        this.revision++,
        null === (e = this.delegate) || void 0 === e || null === (i = e.compositionDidEditAttachment) || void 0 === i
          ? void 0
          : i.call(e, t)
      );
    }
  ...
  class gi extends V {
    ...
    recordUndoEntry(t) {
      let { context: e, consolidatable: i } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
    ...
    createEntry() {
      let { description: t, context: e } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
      return {
  ...
  const mi = (t, e, i) =>
      (null == t ? void 0 : t.description) === (null == e ? void 0 : e.toString()) &&
      ...
      this.findRangesOfPieces().forEach(e => {
        e[1] - e[0] > 1 &&
          ...
          0 !== e[0] &&
            ...
            e[0]++,
            t++),
          (this.document = this.document.applyBlockAttributeAtRange(pi, !0, e)));
      });
    }
    findRangesOfBlocks() {
  ...
  class Ai {
    ...
    loadJSON(t) {
      ...
      return (e = qe.fromJSON(e)), this.loadSnapshot({ document: e, selectedRange: i });
    }
    loadSnapshot(t) {
  ...
  class xi {
    ...
    findLocationFromContainerAndOffset(t, e) {
      let { strict: i } = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : { strict: !0 },
        n = 0,
        r = !1;
      ...
      for (; a.nextNode(); ) {
        ...
        w(s, { strict: i }) ? (r && o.index++, (o.offset = 0), (r = !0)) : (o.offset += yi(s));
      }
      return o;
    }
    findContainerAndOffsetFromLocation(t) {
      ...
      if (n) {
        if (N(n))
          0 === yi(n)
            ? ((e = n.parentNode.parentNode), (i = x(n.parentNode)), B(n, { name: 'right' }) && i++)
            : ((e = n), (i = t.offset - r));
        else {
  ...
  class Ei {
    createDOMRangeFromPoint(t) {
      ...
      if (document.caretPositionFromPoint) {
        const { offsetNode: t, offset: r } = document.caretPositionFromPoint(i, n);
  ...
  class ki extends V {
    constructor(t) {
      super(...arguments),
        ...
        (this.lockCount = 0),
        m('mousedown', { onElement: this.element, withCallback: this.didMouseDown });
    }
    getLocationRange() {
      let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
      return !1 === t.strict
    ...
    updateCurrentLocationRange(t) {
      var e, i;
      if ((null != t ? t : (t = this.createLocationRangeFromDOMRange(Nt()))) && !Dt(t, this.currentLocationRange))
        return (
          (this.currentLocationRange = t),
          null === (e = this.delegate) || void 0 === e || null === (i = e.locationRangeDidChange) || void 0 === i
            ? void 0
        ...
        Ae(
          ...
          Bi(() => {
            ...
            m('input', { onElement: t, withCallback: i }),
              ...
              m('keydown', { onElement: t, withCallback: this.didKeyDownCaption }),
              m('change', { onElement: t, withCallback: this.didChangeCaption }),
    ...
    savePendingCaption() {
      if (this.pendingCaption) {
        ...
        if (((this.pendingCaption = null), r))
          null === (t = this.delegate) ||
            void 0 === t ||
            null === (e = t.attachmentEditorDidRequestUpdatingAttributesForAttachment) ||
            void 0 === e ||
            e.call(t, { caption: r }, this.attachment);
        else
          null === (i = this.delegate) ||
            void 0 === i ||
            null === (n = i.attachmentEditorDidRequestRemovingAttributeForAttachment) ||
            void 0 === n ||
  ...
  class Ii extends V {
    constructor(t, i) {
      super(...arguments),
        ...
        (this.element = t),
        (this.composition = i),
        (this.documentView = new ge(this.composition.document, { element: this.element })),
        m('focus', { onElement: this.element, withCallback: this.didFocus }),
        m('blur', { onElement: this.element, withCallback: this.didBlur }),
        m('click', { onElement: this.element, matchingSelector: 'a[contenteditable=false]', preventDefault: !0 }),
        m('mousedown', { onElement: this.element, matchingSelector: e, withCallback: this.didClickAttachment }),
        m('click', { onElement: this.element, matchingSelector: 'a'.concat(e), preventDefault: !0 });
    }
    didFocus(t) {
      var e;
      const i = () => {
  ...
  class Wi extends V {
    ...
    getTextMutationSummary() {
      const { additions: t, deletions: e } = this.getTextChangesFromCharacterData(),
    ...
    getTextChangesFromChildList() {
      ...
      return { additions: t.filter((t, i) => t !== e[i]).map(Wt), deletions: e.filter((e, i) => e !== t[i]).map(Wt) };
    }
      ...
      if (i.length) {
        const n = i[0],
          ...
          o = (function (t, e) {
            ...
            return (
              (t = $.box(t)),
              (e = $.box(e)).length < t.length ? ([n, i] = Vt(t, e)) : ([i, n] = Vt(e, t)),
              { added: i, removed: n }
            );
  ...
  class Vi extends V {
    constructor(t) {
      ...
      for (const t in this.constructor.events) m(t, { onElement: this.element, withCallback: this.handlerFor(t) });
    }
    elementDidMutate(t) {}
    ...
    attachFiles(t) {
      ...
      return Promise.all(e).then(t => {
        this.handleInput(function () {
          var e, i;
          return (
            null === (e = this.delegate) || void 0 === e || e.inputControllerWillAttachFiles(),
  ...
  class Ki extends Vi {
    ...
    deleteInDirection(t, e) {
      var i;
      return !1 !== (null === (i = this.responder) || void 0 === i ? void 0 : i.deleteInDirection(t))
    ...
    serializeSelectionToDataTransfer(t) {
      ...
      if (
        ...
        return;
      const i =
        null === (e = this.responder) || void 0 === e ? void 0 : e.getSelectedDocument().toSerializableDocument();
      return (
  ...
  Ae(Ki, 'events', {
    keydown(t) {
      ...
      if (e) {
        ...
        ['ctrl', 'alt', 'shift', 'meta'].forEach(e => {
          var i;
          t[''.concat(e, 'Key')] &&
            ('ctrl' === e && (e = 'control'), (n = null === (i = n) || void 0 === i ? void 0 : i[e]));
        }),
          null != (null === (i = n) || void 0 === i ? void 0 : i[e]) &&
            (this.setInputSummary({ keyName: e }), Pt.reset(), n[e].call(this, t));
      }
      if (Ct(t)) {
    ...
    keypress(t) {
      ...
      var i, n;
      return e
        ? (null === (i = this.delegate) || void 0 === i || i.inputControllerWillPerformTyping(),
          null === (n = this.responder) || void 0 === n || n.insertString(e),
          this.setInputSummary({ textAdded: e, didDelete: this.selectionIsExpanded() }))
        : void 0;
    },
    textInput(t) {
      const { data: e } = t,
    ...
    dragstart(t) {
      ...
      return (
        ...
        null === (e = this.delegate) || void 0 === e || null === (i = e.inputControllerDidStartDrag) || void 0 === i
          ? void 0
          : i.call(e)
      );
    },
    ...
    drop(t) {
      ...
      if ((null === (i = this.responder) || void 0 === i || i.setLocationRangeFromPointRange(o), null != n && n.length))
        this.attachFiles(n);
      else if (this.draggedRange) {
        var s, a;
        null === (s = this.delegate) || void 0 === s || s.inputControllerWillMoveText(),
    ...
    cut(t) {
      ...
      if (
        ...
        null === (i = this.delegate) || void 0 === i || i.inputControllerWillCutText(),
    ...
    paste(t) {
      ...
      if (!e || Yi(t))
        return void this.getPastedHTMLUsingHiddenElement(t => {
          ...
          return (
            (i.type = 'text/html'),
            (i.html = t),
            null === (e = this.delegate) || void 0 === e || e.inputControllerWillPaste(i),
            null === (n = this.responder) || void 0 === n || n.insertHTML(i.html),
            this.requestRender(),
            null === (r = this.delegate) || void 0 === r ? void 0 : r.inputControllerDidPaste(i)
          );
        });
      ...
      if (n) {
        ...
        (i.type = 'text/html'),
          ...
          null === (s = this.delegate) || void 0 === s || s.inputControllerWillPaste(i),
          this.setInputSummary({ textAdded: t, didDelete: this.selectionIsExpanded() }),
          null === (a = this.responder) || void 0 === a || a.insertHTML(i.html),
          this.requestRender(),
          null === (l = this.delegate) || void 0 === l || l.inputControllerDidPaste(i);
      } else if (yt(e)) {
        var c, u, h;
        (i.type = 'text/plain'),
          (i.string = e.getData('text/plain')),
          null === (c = this.delegate) || void 0 === c || c.inputControllerWillPaste(i),
          this.setInputSummary({ textAdded: i.string, didDelete: this.selectionIsExpanded() }),
          null === (u = this.responder) || void 0 === u || u.insertString(i.string),
          this.requestRender(),
          null === (h = this.delegate) || void 0 === h || h.inputControllerDidPaste(i);
      } else if (r) {
        var d, g, m;
        (i.type = 'text/html'),
          (i.html = r),
          null === (d = this.delegate) || void 0 === d || d.inputControllerWillPaste(i),
          null === (g = this.responder) || void 0 === g || g.insertHTML(i.html),
          this.requestRender(),
          null === (m = this.delegate) || void 0 === m || m.inputControllerDidPaste(i);
        ...
        if (t) {
          ...
          !t.name && e && (t.name = 'pasted-file-'.concat(++Ji, '.').concat(e)),
            (i.type = 'File'),
            (i.file = t),
            null === (v = this.delegate) || void 0 === v || v.inputControllerWillAttachFiles(),
            null === (A = this.responder) || void 0 === A || A.insertFile(i.file),
            this.requestRender(),
            null === (x = this.delegate) || void 0 === x || x.inputControllerDidPaste(i);
        }
      }
      t.preventDefault();
    },
    ...
    Ae(Ki, 'keys', {
      backspace(t) {
        var e;
        return (
          null === (e = this.delegate) || void 0 === e || e.inputControllerWillPerformTyping(),
      ...
      return(t) {
        ...
        return (
          ...
          null === (e = this.delegate) || void 0 === e || e.inputControllerWillPerformTyping(),
          null === (i = this.responder) || void 0 === i ? void 0 : i.insertLineBreak()
        );
      },
      tab(t) {
        var e, i;
        null !== (e = this.responder) &&
          ...
          (null === (i = this.responder) || void 0 === i || i.increaseNestingLevel(),
          this.requestRender(),
          t.preventDefault());
      },
      left(t) {
      ...
      shift: {
        ...
        tab(t) {
          ...
          null !== (e = this.responder) &&
            ...
            (null === (i = this.responder) || void 0 === i || i.decreaseNestingLevel(),
            this.requestRender(),
            t.preventDefault());
        },
        left(t) {
  ...
  const Gi = t => {
      var e, i;
      return null === (e = t.type) || void 0 === e || null === (i = e.match(/\/(\w+)$/)) || void 0 === i
        ? void 0
        : i[1];
    },
    ...
    Xi = function (t) {
      if (t.key && $i && t.key.codePointAt(0) === t.keyCode) return t.key;
      {
        let e;
        if (
          (null === t.which ? (e = t.keyCode) : 0 !== t.which && 0 !== t.charCode && (e = t.charCode),
          null != e && 'escape' !== Hi[e])
        )
  ...
  class Qi extends V {
    ...
    start(t) {
      if (((this.data.start = t), this.isSignificant())) {
        ...
        if ('keypress' === this.inputSummary.eventName && this.inputSummary.textAdded)
          null === (i = this.responder) || void 0 === i || i.deleteInDirection('left');
        this.selectionIsExpanded() || (this.insertPlaceholder(), this.requestRender()),
          (this.range = null === (e = this.responder) || void 0 === e ? void 0 : e.getSelectedRange());
      }
    }
    update(t) {
          ...
          ? (this.forgetPlaceholder(),
            this.canApplyToDocument()
              ? (this.setInputSummary({ preferDocument: !0, didInput: !1 }),
                null === (e = this.delegate) || void 0 === e || e.inputControllerWillPerformTyping(),
                null === (i = this.responder) || void 0 === i || i.setSelectedRange(this.range),
                null === (n = this.responder) || void 0 === n || n.insertString(this.data.end),
    ...
    canApplyToDocument() {
      var t, e;
      return (
        0 === (null === (t = this.data.start) || void 0 === t ? void 0 : t.length) &&
        (null === (e = this.data.end) || void 0 === e ? void 0 : e.length) > 0 &&
        this.range
      );
    }
  }
  ...
  class Zi extends Vi {
    ...
    render() {
      var t, e;
      (cancelAnimationFrame(this.scheduledRender), (this.scheduledRender = null), this.composing) ||
        null === (e = this.delegate) ||
        void 0 === e ||
        e.render();
    ...
    toggleAttributeIfSupported(t) {
      ...
      if (ht().includes(t))
        return (
          null === (e = this.delegate) || void 0 === e || e.inputControllerWillPerformFormatting(t),
          this.withTargetDOMRange(function () {
            var e;
    ...
    activateAttributeIfSupported(t, e) {
      ...
      if (ht().includes(t))
        return (
          null === (i = this.delegate) || void 0 === i || i.inputControllerWillPerformFormatting(t),
          this.withTargetDOMRange(function () {
            var i;
    ...
    deleteInDirection(t) {
      let { recordUndoEntry: e } =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { recordUndoEntry: !0 };
      var i;
    ...
    getTargetDOMRange() {
      var t, e;
      let { minLength: i } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : { minLength: 0 };
  ...
  Ae(Zi, 'events', {
    ...
    paste(t) {
      ...
      return nn(t)
        ...
        ? (t.preventDefault(),
          ...
          null === (r = this.delegate) || void 0 === r || r.inputControllerWillPaste(i),
          null === (o = this.responder) || void 0 === o || o.insertString(i.string),
          this.render(),
          null === (s = this.delegate) || void 0 === s ? void 0 : s.inputControllerDidPaste(i))
        : n
        ? (t.preventDefault(),
          (i = { type: 'text/html', html: this.createLinkHTML(n) }),
          null === (a = this.delegate) || void 0 === a || a.inputControllerWillPaste(i),
          null === (l = this.responder) || void 0 === l || l.insertHTML(i.html),
          this.render(),
          null === (c = this.delegate) || void 0 === c ? void 0 : c.inputControllerDidPaste(i))
        : void 0;
      var r, o, s, a, l, c;
    },
    beforeinput(t) {
      ...
      if (this.dragging) {
        ...
        if (!Et(i, this.dragging.point))
          return (
            ...
            null === (e = this.responder) || void 0 === e ? void 0 : e.setLocationRangeFromPointRange(i)
          );
    ...
    drop(t) {
      ...
      if (this.dragging)
        return (
          t.preventDefault(),
          null === (e = this.delegate) || void 0 === e || e.inputControllerWillMoveText(),
          null === (i = this.responder) || void 0 === i || i.moveTextFromRange(this.dragging.range),
          (this.dragging = null),
          this.scheduleRender()
        );
      if (en(t)) {
        ...
        const e = sn(t);
        return (
          null === (n = this.responder) || void 0 === n || n.setLocationRangeFromPointRange(e),
    ...
    dragend() {
      var t;
      this.dragging &&
        (null === (t = this.responder) || void 0 === t || t.setSelectedRange(this.dragging.range),
        (this.dragging = null));
    },
    compositionend(t) {
    ...
    Ae(Zi, 'keys', {
      ArrowLeft() {
        var t, e;
        if (null !== (t = this.responder) && void 0 !== t && t.shouldManageMovingCursorInDirection('backward'))
          return (
      ...
      ArrowRight() {
        var t, e;
        if (null !== (t = this.responder) && void 0 !== t && t.shouldManageMovingCursorInDirection('forward'))
          return (
            this.event.preventDefault(),
            null === (e = this.responder) || void 0 === e ? void 0 : e.moveCursorInDirection('forward')
          );
      ...
      Backspace() {
        var t, e, i;
        if (null !== (t = this.responder) && void 0 !== t && t.shouldManageDeletingInDirection('backward'))
          return (
            this.event.preventDefault(),
            null === (e = this.delegate) || void 0 === e || e.inputControllerWillPerformTyping(),
            null === (i = this.responder) || void 0 === i || i.deleteInDirection('backward'),
            this.render()
          );
      },
      Tab() {
        var t, e;
        if (null !== (t = this.responder) && void 0 !== t && t.canIncreaseNestingLevel())
          return (
            this.event.preventDefault(),
            null === (e = this.responder) || void 0 === e || e.increaseNestingLevel(),
            this.render()
          );
      },
      'Tab+Shift'() {
        var t, e;
        if (null !== (t = this.responder) && void 0 !== t && t.canDecreaseNestingLevel())
          return (
            this.event.preventDefault(),
            null === (e = this.responder) || void 0 === e || e.decreaseNestingLevel(),
            this.render()
          );
      }
    }),
    Ae(Zi, 'inputTypes', {
      ...
      insertFromPaste() {
        ...
        if (n) {
          ...
          (t = r ? Ut(r).trim() : n),
            (i.html = this.createLinkHTML(n, t)),
            null === (o = this.delegate) || void 0 === o || o.inputControllerWillPaste(i),
            this.withTargetDOMRange(function () {
              var t;
          ...
          (i.type = 'File'),
            (i.file = e.files[0]),
            null === (l = this.delegate) || void 0 === l || l.inputControllerWillPaste(i),
            this.withTargetDOMRange(function () {
              var t;
      ...
      insertText() {
        var t;
        return this.insertString(
          this.event.data || (null === (t = this.event.dataTransfer) || void 0 === t ? void 0 : t.getData('text/plain'))
        );
      },
      insertTranspose() {
        return this.insertString(this.event.data);
  ...
  class bn extends V {
    constructor(t) {
      super(t),
        ...
        m('mousedown', { onElement: this.element, matchingSelector: ln, withCallback: this.didClickActionButton }),
        m('mousedown', { onElement: this.element, matchingSelector: an, withCallback: this.didClickAttributeButton }),
        m('click', { onElement: this.element, matchingSelector: cn, preventDefault: !0 }),
        m('click', { onElement: this.element, matchingSelector: dn, withCallback: this.didClickDialogButton }),
        m('keydown', { onElement: this.element, matchingSelector: gn, withCallback: this.didKeyDownDialogInput });
    }
    ...
    didClickAttributeButton(t, e) {
      ...
      this.getDialog(n)
        ? this.toggleDialog(n)
        : null === (r = this.delegate) || void 0 === r || r.toolbarDidToggleAttribute(n);
    ...
    applyKeyboardCommand(t) {
      ...
      for (const t of Array.from(this.element.querySelectorAll('[data-trix-key]'))) {
        ...
        if (JSON.stringify(i.sort()) === e) return p('mousedown', { onElement: t }), !0;
      }
      return !1;
    }
    dialogIsVisible(t) {
    ...
    setAttribute(t) {
      ...
      return i.willValidate && !i.checkValidity()
        ? (i.setAttribute('data-trix-validate', ''), i.classList.add('trix-validate'), i.focus())
        : (null === (n = this.delegate) || void 0 === n || n.toolbarDidUpdateAttribute(e, i.value), this.hideDialog());
      var n;
    }
    removeAttribute(t) {
      var e;
      ...
      if (t)
        return (
          ...
          null === (e = this.delegate) || void 0 === e
            ? void 0
            : e.toolbarDidHideDialog((t => t.getAttribute('data-trix-dialog'))(t))
        );
    }
    resetDialogInputs() {
  ...
  class vn extends Ni {
    constructor(t) {
      ...
      super(...arguments),
        ...
        (this.inputController = 2 === O.getLevel() ? new Zi(this.editorElement) : new Ki(this.editorElement)),
        (this.inputController.delegate = this),
        (this.inputController.responder = this.composition),
        (this.compositionController = new Ii(this.editorElement, this.composition)),
        (this.compositionController.delegate = this),
        (this.toolbarController = new bn(this.editorElement.toolbarElement)),
        (this.toolbarController.delegate = this),
        (this.editor = new Ai(this.composition, this.selectionManager, this.editorElement)),
    ...
    freezeSelection() {
      if (!this.selectionFrozen)
        return (
          this.selectionManager.lock(), this.composition.freezeSelection(), (this.selectionFrozen = !0), this.render()
        );
    }
    thawSelection() {
      if (this.selectionFrozen)
        return (
          this.composition.thawSelection(), this.selectionManager.unlock(), (this.selectionFrozen = !1), this.render()
        );
    }
    canInvokeAction(t) {
      return (
        !!this.actionIsExternal(t) ||
        !(null === (e = this.actions[t]) || void 0 === e || null === (i = e.test) || void 0 === i || !i.call(this))
      );
      var e, i;
    }
    invokeAction(t) {
      return this.actionIsExternal(t)
        ...
        : null === (e = this.actions[t]) || void 0 === e || null === (i = e.perform) || void 0 === i
        ? void 0
        : i.call(this);
      var e, i;
    }
    ...
    runEditorFilters() {
      ...
      if (
        ...
        !Dt(e.selectedRange, i.selectedRange) || !e.document.isEqualTo(i.document))
      )
    ...
    isFocused() {
      ...
      return (
        this.editorElement ===
        (null === (t = this.editorElement.ownerDocument) || void 0 === t ? void 0 : t.activeElement)
      );
    }
    isFocusedInvisibly() {
  ...
  const Sn = function (t) {
    ...
    kn = function (t) {
      var e, i;
      if (null !== (e = (i = document).queryCommandSupported) && void 0 !== e && e.call(i, 'enableObjectResizing'))
        return (
  ...
  class wn extends HTMLElement {
    ...
    get labels() {
      ...
      this.id &&
        this.ownerDocument &&
        t.push(...Array.from(this.ownerDocument.querySelectorAll("label[for='".concat(this.id, "']")) || []));
    ...
    notify(t, e) {
      if (this.editorController) return p('trix-'.concat(t), { onElement: this, attributes: e });
    }
    ...
    connectedCallback() {
      this.hasAttribute('data-trix-internal') ||
        ...
        this.editorController ||
          ...
          (this.editorController = new vn({ editorElement: this, html: (this.defaultValue = this.value) })),
          requestAnimationFrame(() => p('trix-initialize', { onElement: this }))),
    ...
    disconnectedCallback() {
      var t;
      return (
        null === (t = this.editorController) || void 0 === t || t.unregisterSelectionManager(),
    ...
    registerResetListener() {
      return (
        (this.resetListener = this.resetBubbled.bind(this)), window.addEventListener('reset', this.resetListener, !1)
      );
    }
    ...
    registerClickListener() {
      return (
        (this.clickListener = this.clickBubbled.bind(this)), window.addEventListener('click', this.clickListener, !1)
      );
    }
  ...
  const Tn = {
    ...
    observers: xn,
    operations: yn,
    elements: Object.freeze({ __proto__: null, TrixEditorElement: wn, TrixToolbarElement: Cn }),
    filters: Object.freeze({ __proto__: null, Filter: fi, attachmentGalleryFilter: bi })
  };
  return (
    (window.Trix = Tn),
    setTimeout(function () {
      customElements.get('trix-toolbar') || customElements.define('trix-toolbar', Cn),
        customElements.get('trix-editor') || customElements.define('trix-editor', wn);
    }, 0),
    Tn
  );
});
